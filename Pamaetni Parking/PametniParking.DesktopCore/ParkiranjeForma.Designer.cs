namespace PametniParking.DesktopCore
{
    partial class ParkiranjeForma
    {
        ...
        {
            dgvParkiranja = new System.Windows.Forms.DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)(dgvParkiranja)).BeginInit();
            SuspendLayout();

            dgvParkiranja.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvParkiranja.Dock = System.Windows.Forms.DockStyle.Top;
            dgvParkiranja.ReadOnly = true;
            dgvParkiranja.Size = new System.Drawing.Size(800, 354);
            ...
            Controls.Add(btnIzlaz); Controls.Add(btnObrisi); Controls.Add(btnDodaj); Controls.Add(btnIzmeni); Controls.Add(dgvParkiranja);
            Name = "ParkiranjeForma";
            Text = "Parkiranja";
            Load += new EventHandler(ParkiranjeForma_Load);
            ((System.ComponentModel.ISupportInitialize)(dgvParkiranja)).EndInit();
            ResumeLayout(false);
        }
    }
}