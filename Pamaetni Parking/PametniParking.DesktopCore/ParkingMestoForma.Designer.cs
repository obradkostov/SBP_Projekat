namespace PametniParking.DesktopCore
{
    partial class ParkingMestoForma
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvMesta.Dock = System.Windows.Forms.DockStyle.Top;
            dgvMesta.ReadOnly = true;
            dgvMesta.Size = new System.Drawing.Size(800, 354);
            ...
            Controls.Add(btnIzlaz); Controls.Add(btnObrisi); Controls.Add(btnDodaj); Controls.Add(btnIzmeni); Controls.Add(dgvMesta);
            Name = "ParkingMestoForma";
            Text = "Parking mesta";
            Load += new EventHandler(ParkingMestoForma_Load);
