namespace PametniParking.DesktopCore
{
    partial class SenzorForma
    {
        ...
        {
            dgvSenzori = new System.Windows.Forms.DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)(dgvSenzori)).BeginInit();
            SuspendLayout();

            dgvSenzori.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvSenzori.Dock = System.Windows.Forms.DockStyle.Top;
            dgvSenzori.ReadOnly = true;
            dgvSenzori.Size = new System.Drawing.Size(800, 354);
            ...
            Controls.Add(btnIzlaz); Controls.Add(btnObrisi); Controls.Add(btnDodaj); Controls.Add(btnIzmeni); Controls.Add(dgvSenzori);
            Name = "SenzorForma";
            Text = "Senzori";
            Load += new EventHandler(SenzorForma_Load);
            ((System.ComponentModel.ISupportInitialize)(dgvSenzori)).EndInit();
            ResumeLayout(false);
        }
    }
}