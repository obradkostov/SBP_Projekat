...
{
    partial class PretplatnaKartaForma
    {
        ...
        {
            dgvKarte = new System.Windows.Forms.DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)(dgvKarte)).BeginInit();
            SuspendLayout();

            dgvKarte.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvKarte.Dock = System.Windows.Forms.DockStyle.Top;
            dgvKarte.ReadOnly = true;
            dgvKarte.Size = new System.Drawing.Size(800, 354);
            ...
            Controls.Add(btnIzlaz); Controls.Add(btnObrisi); Controls.Add(btnDodaj); Controls.Add(btnIzmeni); Controls.Add(dgvKarte);
            Name = "PretplatnaKartaForma";
            Text = "Pretplatne karte";
            Load += new EventHandler(PretplatnaKartaForma_Load);
            ((System.ComponentModel.ISupportInitialize)(dgvKarte)).EndInit();
            ResumeLayout(false);
        }
    }
}